...
from src.utils import NPZDatasetBinaryFeatures, compute_binary_metrics, extract_predictions_binary, folds_creation, get_dataset_split, folds_statistics
from src.models import MLPBinary
...
model   = MLPBinary(input_dim=1024, num_classes=NUM_CLASSES).to(device)
